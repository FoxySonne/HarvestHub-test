export const database = {
  ...
  action: [
    ...
    {name: "Желаемый призыв", id: "wish_summon", categoryId: "heroes", points: {turtle: 20000, vs: 13400, ipk: 0}, vsBranchBonusPercent: 150},
    {name: "Продвинутый призыв", id: "advanced_summon", categoryId: "heroes", points: {turtle: 8000, vs: 3000, ipk: 0}, vsBranchBonusPercent: 150},
    {name: "Стандартный призыв", id: "standard_summon", categoryId: "heroes", points: {turtle: 2000, vs: 500, ipk: 0}, vsBranchBonusPercent: 150},
    {name: "Синий фрагмент героя", id: "blue_hero_card", categoryId: "heroes", points: {turtle: 3000, vs: 160, ipk: 150}, vsBranchBonusPercent: 100},
    {name: "Фиолетовый фрагмент героя", id: "purple_hero_card", categoryId: "heroes", points: {turtle: 9000, vs: 1600, ipk: 1000}, vsBranchBonusPercent: 100},
    {name: "Золотой фрагмент героя", id: "gold_hero_card", categoryId: "heroes", points: {turtle: 35000, vs: 15200, ipk: 9000}, vsBranchBonusPercent: 100},
    {name: "Книги героев", id: "hero_books", categoryId: "heroes", points: {turtle: 2500, vs: 5000, ipk: 857}, vsBranchBonusPercent: 100},

    {name: "Опыт титана 100 ед", id: "titan_exp_100", categoryId: "titan", points: {turtle: 1000, vs: 1000, ipk: 200}, vsBranchBonusPercent: 100},
    {name: "Клетки титана", id: "titan_cells", categoryId: "titan", points: {turtle: 20000, vs: 12000, ipk: 2800}, vsBranchBonusPercent: 100},
    {name: "1 ед. биогенного белка", id: "biogenic_protein", categoryId: "titan", points: {turtle: 12000, vs: 10000, ipk: 0}, vsBranchBonusPercent: 100},
...

    {
      ...
      points: {
        ...
        ipk: {1: 4, 2: 7, 3: 12, 4: 15, 5: 18, 6: 22, 7: 25, 8: 30, 9: 35, 10: 40},}, vsBranchBonusPercent: 150},

    {name: "Ускорение исследований 1 мин", id: "research_1m", categoryId: "speedups", points: {turtle: 700, vs: 250, ipk: 42}, vsBranchBonusPercent: 150},
    {name: "Ускорение строительства 1 мин", id: "building_1m", categoryId: "speedups", points: {turtle: 700, vs: 250, ipk: 42}, vsBranchBonusPercent: 150},
    {name: "Ускорение исцеления 1 мин", id: "healing_1m", categoryId: "speedups", points: {turtle: 0, vs: 250, ipk: 0}, vsBranchBonusPercent: 150},
    {name: "Ускорение обучения 1 мин", id: "training_1m", categoryId: "speedups", points: {turtle: 0, vs: 250, ipk: 42}, vsBranchBonusPercent: 150},

    {name: "Увеличьте силу на 1 с помощью строительства", id: "building_power", categoryId: "power", points: {turtle: 0, vs: 4, ipk: 3}, vsBranchBonusPercent: 150},
    {name: "Увеличьте силу на 1 с помощью исследования", id: "research_power", categoryId: "power", points: {turtle: 0, vs: 9, ipk: 3}, vsBranchBonusPercent: 150},

    {name: "Собрать 100 ед. еды", id: "food_100", categoryId: "resource_gathering", points: {turtle: 2, vs: 1, ipk: 0}, vsBranchBonusPercent: 100},
    {name: "Собрать 100 ед. древесины", id: "wood_100", categoryId: "resource_gathering", points: {turtle: 2, vs: 1, ipk: 0}, vsBranchBonusPercent: 100},
    {name: "Собрать 20 ед. металла", id: "metal_20", categoryId: "resource_gathering", points: {turtle: 2, vs: 1, ipk: 0}, vsBranchBonusPercent: 100},
    {name: "Собрать 5 ед. топлива", id: "fuel_5", categoryId: "resource_gathering", points: {turtle: 2, vs: 1, ipk: 0}, vsBranchBonusPercent: 100},
    ...
    {name: "Завершение разведмиссий", id: "recon_mon_fri", categoryId: "misc", points: {turtle: 0, vs: 37500, ipk: 30000}, vsBranchBonusPercent: 150},
    {name: "Завершение разведмиссий", id: "recon_wed", categoryId: "misc", points: {turtle: 0, vs: 30000, ipk: 0}, vsBranchBonusPercent: 150},
    {name: "Отправки S-класс", id: "dispatch_s", categoryId: "misc", quantityOptions: {min: 1, max: 8}, points: {turtle: 0, vs: 75000, ipk: 0}, vsBranchBonusPercent: 100},
    {name: "Грузовики А-класс", id: "truck_a", categoryId: "misc", quantityOptions: {min: 1, max: 4}, points: {turtle: 0, vs: 50000, ipk: 0}, vsBranchBonusPercent: 100},
    {name: "Используйте очки выносливости", id: "stamina_points", categoryId: "misc", points: {turtle: 0, vs: 300, ipk: 0}, vsBranchBonusPercent: 100},
    {name: "Используйте очки VS", id: "vs_points", categoryId: "misc", points: {turtle: 0, vs: 2500, ipk: 0}, vsBranchBonusPercent: 100},
